...
<div class="row">
  ...
  <div class="form-group">
    ...
    <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">RD</label>
    <div class="col-md-6">
    ...
    <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Partida / Lote*</label>
    <div class="col-md-6">
      <input type="text" name="partida_lote" required class="form-control" id="partida_lote" placeholder="Partida / Lote">
    </div>
  </div>
