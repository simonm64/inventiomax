...
<?php endif;?>
  ...
  <div class="form-group">
    ...
    <?php endforeach;?>
      ...
      <div class="form-group">
    <label for="inputEmail1" class="col-lg-3 control-label">RD</label>
    <div class="col-md-8">
    <select name="rd_id" class="form-control">
    <option value="">-- NINGUNA --</option>
    <?php foreach($rds as $rd):?>
      <option value="<?php echo $rd->id;?>" <?php if($product->rd_id!=null&& $product->rd_id==$rd->id){ echo "selected";}?>><?php echo $rd->name;?></option>
    <?php endforeach;?>
      </select>    </div>
  </div>
  
    <div class="form-group">
    <label for="inputEmail1" class="col-lg-3 control-label">Partida / Lote*</label>
    <div class="col-md-8">
      <input type="text" name="partida_lote" class="form-control" value="<?php echo $product->partida_lote; ?>" id="partida_lote" placeholder="Partida / Lote">
    </div>
  </div>
